   ...
   public  class Email : IAlerta
    {
        ...
        private string GenerarDetalleProductos(List<InventarioDTO> ElementoVencidos) {
            ...
            Detalle.AppendLine("<table style='font-size:15px;margin:auto;color:white' ><tr><td>Producto</td><td>Código Lote</td><td>Fecha Vencimiento</td><td></td><td>Cantidad</td></tr>");
